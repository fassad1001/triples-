...
void TOntology::TestMainSuperClass_data()
{
    ...
    QTest::newRow("1 minimal class3")
            << (Ontology(QSet<Triple>()
                         ...
                         <<Triple("classA", Ontology::CONTAINS, "classD")
                         <<Triple("classB", Ontology::CONTAINS, "classE")
                         <<Triple("classB", Ontology::CONTAINS, "classC")
                         <<Triple("classD", Ontology::CONTAINS, "classH")
                         <<Triple("classE", Ontology::CONTAINS, "classK")
                         <<Triple("classE", Ontology::CONTAINS, "classF")
                         <<Triple("classE", Ontology::CONTAINS, "classG")
                         <<Triple("instance1", Ontology::IS, "classK")
                         <<Triple("instance3", Ontology::IS, "classG")))
            <<("instance1")
           <<("instance3")
          <<(QSet<QString>()
             <<"classE");
    ...
    QTest::newRow("1 minimal class2")
            << (Ontology(QSet<Triple>()
                         ...
                         <<Triple("classE", Ontology::CONTAINS, "classF")
                         <<Triple("classE", Ontology::CONTAINS, "classG")
                         <<Triple("instance2", Ontology::IS, "classF")
                         <<Triple("instance4", Ontology::IS, "classC")))
            <<("instance2")
           <<("instance4")
          <<(QSet<QString>()
             <<"classB");
    ...
    QTest::newRow("1 minimal class1")
            << (Ontology(QSet<Triple>()
                         ...
                         <<Triple("classE", Ontology::CONTAINS, "classG")
                         <<Triple("instance3", Ontology::IS, "classG")
                         <<Triple("instance5", Ontology::IS, "classH")))
            <<("instance3")
           <<("instance5")
          <<(QSet<QString>()
             <<"classA");
...
void TOntology::TestInstancesForProperties_data()
{
    ...
    QTest::newRow("3 classes, no branching, 1 header class")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
    ...
    QTest::newRow("3 classes, no branching, 1 header class")
            <<(Ontology(QSet<Triple>()
                        ...
                        <<Triple("instance3", "property3", "value3")))
           <<(MyHash()
              .insertInc("property1", "value112")
              .insertInc("property2", "value2")
              .insertInc("property3", "value4"))
          <<(QSet<QString>()
             <<"instance2");

    QTest::newRow("4 classes, branching, 1 header class")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
    ...
    QTest::newRow("4 classes, branching, 1 header class")
           ...
           <<(MyHash()
              .insertIncMulti("property1", "value1")
              .insertIncMulti("property2", "value14")
              .insertIncMulti("property1", "value3")
              .insertIncMulti("property2", "value4"))
          <<(QSet<QString>()
             <<"instance1"
    ...
    QTest::newRow("8 classes, branching, 2 header class")
           ...
           <<(MyHash()
              .insertIncMulti("property1", "value1")
              .insertIncMulti("property2", "value2")
              .insertIncMulti("property5", "value4")
              .insertIncMulti("property6", "value12"))
          <<(QSet<QString>()
             <<"instance1"
             <<"instance2");

    QTest::newRow("8 classes, branching, 2 header class fake values")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
...
void TOntology::TestInstancesForNonProperties_data()
{
    ...
    QTest::newRow("4 classes, branching, 1 header class")
            <<(Ontology(QSet<Triple>()
                        ...
                        <<Triple("instance4", "property2", "value4")))
           <<(MyHash()
              .insertIncMulti("property1", "value4")
              .insertIncMulti("property2", "value3"))
          <<(QSet<QString>()
             <<"instance1"
             <<"instance2"
             <<"instance3"
    ...
    QTest::newRow("8 classes, branching, 2 header class")
            <<(Ontology(QSet<Triple>()
                        ...
                        <<Triple("instance4", "property6", "value4")))
           <<(MyHash()
              .insertIncMulti("property1", "value5")
              .insertIncMulti("property2", "value12"))
          <<(QSet<QString>()
             <<"instance1"
             <<"instance2");
    ...
    QTest::newRow("8 classes, branching, 2 header class fake values")
            <<(Ontology(QSet<Triple>()
                        ...
                        <<Triple("instance4", "property6", "value4")))
           <<(MyHash()
              .insertIncMulti("property1", "value10")
              .insertIncMulti("property2", "value20")
              .insertIncMulti("property5", "value30")
              .insertIncMulti("property6", "value40"))
          <<(QSet<QString>()
             <<"instance1"
             <<"instance2"
             <<"instance3"

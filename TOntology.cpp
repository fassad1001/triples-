...
void TOntology::TestClassInstances_data()
{
    ...
    QTest::newRow("blank-ontology")
            << (Ontology(QSet<Triple>()))
            <<("class123")
           <<(QSet<QString>());

    QTest::newRow("class-without-instances")
            << (Ontology(QSet<Triple>()
                         << Triple("class1", Ontology::IS, Ontology::CLASS)))
            <<("class1")
           <<(QSet<QString>());

    QTest::newRow("class-with-1-instance")
            << (Ontology(QSet<Triple>()
                         << Triple("class1", Ontology::IS, Ontology::CLASS)
    ...
    QTest::newRow("two-instances-with-inheritance")
            << (Ontology(QSet<Triple>()
                         << Triple("class1", Ontology::IS, Ontology::CLASS)
...
void TOntology::TestAnyClassInstances_data()
{
    ...
    QTest::newRow("class-with-one-instance")
            << (Ontology(QSet<Triple>()
                         << Triple("class1", Ontology::IS, Ontology::CLASS)
                         << Triple("instance1", Ontology::IS, "class1")
                         ))
    ...
    QTest::newRow("fake-class-as-argument")
            << (Ontology(QSet<Triple>()
                         << Triple("class1", Ontology::IS, Ontology::CLASS)
                         << Triple("class2", Ontology::IS, Ontology::CLASS)
                         << Triple("instance1", Ontology::IS, "class1")))
    ...
    QTest::newRow("class-has-instances-as-instances-of-other-class")
            << (Ontology(QSet<Triple>()
                         << Triple("class1", Ontology::IS, Ontology::CLASS)
                         << Triple("class2", Ontology::IS, Ontology::CLASS)
                         << Triple("class1", Ontology::CONTAINS, "class2")
    ...
    QTest::newRow("class-has-instances-as-instances-of-other-class-2")
            << (Ontology(QSet<Triple>()
                         << Triple("class1", Ontology::IS, Ontology::CLASS)
                         << Triple("class2", Ontology::IS, Ontology::CLASS)
...
void TOntology::TestAllClassInstances_data()
{
    ...
    QTest::newRow("class-with-2-instances-and-inheritance")
            << (Ontology(QSet<Triple>()
                         << Triple("class1", Ontology::IS, Ontology::CLASS)
                         << Triple("class2", Ontology::IS, Ontology::CLASS)
                         << Triple("class3", Ontology::IS, Ontology::CLASS)
...
void TOntology::TestAllClasses_data()
{
    ...
    QTest::newRow("ontology-with-1-class")
            << (Ontology(QSet<Triple>()
                         <<Triple("class1", Ontology::IS, Ontology::CLASS)
                         ))
            <<(QSet<QString>()
    ...
    QTest::newRow("ontology-with-inheritance")
            << (Ontology(QSet<Triple>()
                         <<Triple("class1", Ontology::IS, Ontology::CLASS)
                         <<Triple("class2", Ontology::IS, Ontology::CLASS)
                         <<Triple("class1", Ontology::CONTAINS, "class2")
...
void TOntology::TestAllInstances_data()
{
    ...
    QTest::newRow("Ontology-with-2-classes")
            << (Ontology(QSet<Triple>()
                         <<Triple("cat", Ontology::IS,"animal")
    ...
    QTest::newRow("Ontology-with-2-classes-without-instances")
            << (Ontology(QSet<Triple>()
                         <<Triple("animal", Ontology::IS, Ontology::CLASS)
                         <<Triple("another_animal", Ontology::IS, Ontology::CLASS)
                         ))
    ...
    QTest::newRow("Ontology-with-inheritance-class")
            << (Ontology(QSet<Triple>()
                         <<Triple("cat", Ontology::IS,"animal")
                         <<Triple("dog", Ontology::IS,"another_animal")
                         <<Triple("animal", Ontology::IS, Ontology::CLASS)
...
void TOntology::TestClassesForInstance_data()
{
    ...
    QTest::newRow("fake instance name")
            << (Ontology(QSet<Triple>()
                         <<(Triple("class1", Ontology::IS, Ontology::CLASS))
                         <<(Triple("class2", Ontology::IS, Ontology::CLASS))
                         <<(Triple("class1", Ontology::CONTAINS, "class2"))
...
void TOntology::TestSubClasses_data()
{
    ...
    QTest::newRow("ontology-with-3-classes-and-inheritance")
            << (Ontology(QSet<Triple>()
                         <<Triple("class1",Ontology::CONTAINS,"class2")
                         <<Triple("class2",Ontology::CONTAINS,"class3")
                         <<Triple("instance1",Ontology::IS,"class1")
...
void TOntology::TestMainSuperClass_data()
{
    ...
    QTest::newRow("ontology-without-class-decraration")
            << (Ontology(QSet<Triple>()
                         <<Triple("instance1", Ontology::IS, "class1")
    ...
    QTest::newRow("1 mainsuperclass")
            << (Ontology(QSet<Triple>()
                         ...
                         <<Triple("class1", Ontology::CONTAINS, "class2")
                         <<Triple("class1", Ontology::CONTAINS, "class3")
                         <<Triple("class3", Ontology::CONTAINS, "class6")
                         <<Triple("class2", Ontology::CONTAINS, "class4")
                         <<Triple("class2", Ontology::CONTAINS, "class5")
                         <<Triple("class4", Ontology::CONTAINS, "class7")
                         <<Triple("class4", Ontology::CONTAINS, "class8")
                         <<Triple("instance1", Ontology::IS, "class7")
                         <<Triple("instance2", Ontology::IS, "class8")
                         <<Triple("instance3", Ontology::IS, "class5")
                         <<Triple("instance4", Ontology::IS, "class6")))
            <<("instance1")
           <<("instance2")
          <<(QSet<QString>()
             <<"class4");
    ...
    QTest::newRow("2 mainsuperclass")
            << (Ontology(QSet<Triple>()
                         ...
                         <<Triple("instance3", Ontology::IS, "class5")
                         <<Triple("instance4", Ontology::IS, "class6")
                         <<Triple("instance5", Ontology::IS, "class7")
                         <<Triple("instance6", Ontology::IS, "class7")
                         <<Triple("instance5", Ontology::IS, "class8")
                         <<Triple("instance6", Ontology::IS, "class8")))
            <<("instance5")
           <<("instance6")
          <<(QSet<QString>()
             <<"class7"
...
void TOntology::TestIsMinimal_data()
{
    ...
    QTest::newRow("4 classes, 1 header class, 1 instance (1 class), minimal true")
            << (Ontology(QSet<Triple>()
                         << Triple("class1", Ontology::CONTAINS,"class2")
                         << Triple("class1", Ontology::CONTAINS,"class3")
                         << Triple("class2", Ontology::CONTAINS,"class4")
    ...
    QTest::newRow("4 classes, 1 header class, 1 instance (2 classes), minimal true")
            << (Ontology(QSet<Triple>()
                         << Triple("class1", Ontology::CONTAINS,"class2")
                         << Triple("class1", Ontology::CONTAINS,"class3")
                         << Triple("class2", Ontology::CONTAINS,"class4")
    ...
    QTest::newRow("4 classes, 1 header class, 2 instances (1 class each), minimal true")
            << (Ontology(QSet<Triple>()
                         << Triple("class1", Ontology::CONTAINS,"class2")
                         << Triple("class1", Ontology::CONTAINS,"class3")
                         << Triple("class2", Ontology::CONTAINS,"class4")
    ...
    QTest::newRow("4 classes, 1 header class, 1 instances (2 classes), minimal false")
            << (Ontology(QSet<Triple>()
                         << Triple("class1", Ontology::CONTAINS,"class2")
                         << Triple("class1", Ontology::CONTAINS,"class3")
                         << Triple("class2", Ontology::CONTAINS,"class4")
    ...
    QTest::newRow("4 classes, 1 header class, 2 instances (2 classes), minimal false")
            << (Ontology(QSet<Triple>()
                         << Triple("class1", Ontology::CONTAINS,"class2")
                         << Triple("class1", Ontology::CONTAINS,"class3")
                         << Triple("class2", Ontology::CONTAINS,"class4")
...
void TOntology::TestIsMinimal()
{
    ...
    QCOMPARE(ontology.isMinimal(QSet<Pair>()<<Pair("1","2")),isItMinimal);
}
...
void TOntology::TestMinimalize_data()
{
    ...
    QTest::addColumn <bool> ("isMinimalItem");

    QTest::newRow("3 classes, 1 instance (3 classes), minimal false")
            << (Ontology(QSet<Triple>()
                         <<Triple("instance1", Ontology::IS, "class1")
                         <<Triple("instance1", Ontology::IS, "class2")
                         <<Triple("instance1", Ontology::IS, "class3")
...
void TOntology::TestMinimalize()
{
    ...
    QCOMPARE(ontology1.isMinimal(QSet<Pair>()<<Pair("1","2")), true);
}
...
void TOntology::TestPropertyValues_data()
{
    ...
    QTest::newRow("3 classes, without branching, 1 header classes, 1 instance")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
    ...
    QTest::newRow("4 classes, with branching, 1 header classes, 2 instances")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
    ...
    QTest::newRow("6 classes, with branching, 2 header classes, 2 instances")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
    ...
    QTest::newRow("6 classes, with branching, 2 header classes, 2 instances")
            <<(Ontology(QSet<Triple>()
                        ...
                        <<Triple("classD", Ontology::CONTAINS, "classK")
                        <<Triple("classA", Ontology::HAS_PROPERTY, "property1")
                        <<Triple("classC", Ontology::HAS_PROPERTY, "property2")
                        <<Triple("instance1", Ontology::IS, "classE")
                        <<Triple("instance1", "property1", "value1")
                        <<Triple("instance2", Ontology::IS, "classG")
                        <<Triple("instance2", "property2", "value4")))
    ...
    QTest::newRow("6 classes, with branching, 2 header classes, 2 instances, fake property")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
...
void TOntology::TestInstanceProperties_data()
{
    ...
    QTest::newRow("3 classes, without branching, 1 header classes, 1 instance, with fake instance")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
...
void TOntology::TestInstancesForProperties_data()
{
    ...
    QTest::newRow("no branching, 1 header class")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
    ...
    QTest::newRow("branching, 1 header class")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
    ...
    QTest::newRow("8 classes, branching, 2 header class")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
    ...
    QTest::newRow("no branching, 1 header class, fake-instance-properties")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
                        ...
                        <<Triple("instance2", "property2", "value2")
                        <<Triple("instance3", "property3", "value3")
                        <<Triple("instance3", "property4", "value3")))
           <<(MyHash()
              .insertInc("property1", "value1")
              .insertInc("property2", "value2")
              .insertInc("property3", "value3")
              .insertInc("property4", "value3"))
          <<(QSet<QString>()
             <<"instance1"
             <<"instance2"
             <<"instance3");
    ...
    QTest::newRow("branching, 1 header class, fake-instance-properties")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
                        ...
                        <<Triple("instance2", "property2", "value2")
                        <<Triple("instance3", "property1", "value3")
                        <<Triple("instance1", "property4", "value1")))
           <<(MyHash()
              .insertIncMulti("property1", "value1")
              .insertIncMulti("property2", "value2")
              .insertIncMulti("property1", "value3")
              .insertIncMulti("property2", "value4")
              .insertIncMulti("property4", "value1"))
          <<(QSet<QString>()
             <<"instance1"
             <<"instance2"
             <<"instance3");

    QTest::newRow("8 classes, branching, 2 header class, fake-instance-properties")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
                        ...
                        <<Triple("instance3", "property5", "value3")
                        <<Triple("instance4", "property6", "value4")
                        <<Triple("instance1", "property5", "value1")))
           <<(MyHash()
              .insertIncMulti("property1", "value1")
              .insertIncMulti("property2", "value2")
              .insertIncMulti("property5", "value3")
              .insertIncMulti("property5", "value1"))
          <<(QSet<QString>()
             <<"instance1"
             <<"instance2"
             <<"instance3");
...
void TOntology::TestInstancesForNonProperties_data()
{
    ...
    QTest::newRow("no branching, 1 header class")
            <<(Ontology(QSet<Triple>()
                        ...
                        <<Triple("instance3", Ontology::IS, "classC")
                        <<Triple("instance1", "property1", "value1")
                        <<Triple("instance2", "property1", "value2")
                        <<Triple("instance3", "property1", "value3")))
           <<(MyHash()
              .insertInc("property1", "value1"))
          <<(QSet<QString>()
    ...
    QTest::newRow("no branching, 1 header class, fake property name")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
                        ...
                        <<Triple("instance3", "property1", "value3")))
           <<(MyHash()
              .insertInc("property666", "value3"))
          <<(QSet<QString>());

    QTest::newRow("no branching, 1 header class, no class declaration")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::CONTAINS, "classB")
                        <<Triple("classB", Ontology::CONTAINS, "classC")
                        <<Triple("classA", Ontology::HAS_PROPERTY, "property1")
    ...
    QTest::newRow("no branching, 1 header class, no properties")
            <<(Ontology(QSet<Triple>()
                        <<Triple("classA", Ontology::IS, Ontology::CLASS)
                        <<Triple("classB", Ontology::IS, Ontology::CLASS)
                        <<Triple("classC", Ontology::IS, Ontology::CLASS)
...
void TOntology::TestTraverseUP_data()
{
    QTest::addColumn <Ontology> ("ontology");
